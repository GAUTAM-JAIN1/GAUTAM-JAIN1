...
const gautam = {
  ...
  education: "BTech CSE @ J.C. Bose University of Science & Technology, YMCA",
  role: "Aspiring Innovator | Problem-Solver | AI Web Developer",
  competitiveStats: "⭐⭐ CodeChef | 300+ LeetCode | 1600+ Codeforces/Contest Rating",
  currentlyBuilding: ["DinePro", "MediSarthi"],
  funFact: "Most of my best ideas start with 'What if we could automate this?'",
...
<br/>
<img src="https://skillicons.dev/icons?i=react,vite,js,html,css,nodejs,express,fastapi,mongodb,firebase&theme=dark" />
...
### 🍽️ DinePro
Multi-tenant restaurant management platform with real-time order tracking, live kitchen updates, billing & role-based access control.

`React` `Express` `Firebase` `Firestore` `Socket.io`

</td>
<td width="50%" valign="top">

### 🏥 MediSarthi
AI-powered healthcare platform — symptom analysis, prescription OCR, medicine safety checks, emergency medical QR & blood donor network.

`AI/ML` `OCR` `Automation` `Real-Time Web`
...
<a href="https://leetcode.com/u/GAUTAM_J001/">
  <img src="https://leetcard.jacoblin.cool/GAUTAM_J001?theme=dark&font=Fira+Code&ext=heatmap" />
</a>
